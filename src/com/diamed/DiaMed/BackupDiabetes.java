...
public class BackupDiabetes extends Activity {
	...
	static String diamedURL = "http://10.0.2.2/diamed/mobile/DiabetesToServer.php";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		dm = new DatabaseManipulator(BackupDiabetes.this);
		...
		for (String[] value : tableValues) {
			...
			dataObject = new DataObject(username,concatId, value[1], value[2], value[3],
					value[4]);
	...
	class addDiaValueToServer extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			...
			if(boolian == 1){
			pDialog = new ProgressDialog(BackupDiabetes.this);
			pDialog.setMessage("Backing Up Diabetes Data. Please wait...");
			...
			runOnUiThread(new Runnable() {
				public void run() {
					...
					Intent i = new Intent(getApplicationContext(),
							BackupOtherDiseases.class);
					i.putExtra("progressbar", boolian);
					BackupDiabetes.this.startActivity(i);
