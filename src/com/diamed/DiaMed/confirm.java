	...
	public void onClick(View v) {
		...
		case R.id.button0:
			...
			try {
				...
				dbase = new Database(confirm.this);
				...
				dbase.open();
					...
					if(dbase.fetchPin().equals(pinNumber)){
						...
						Intent i = new Intent(confirm.this, progressBar.class);
			...
			break;
		case R.id.cancel:
			Intent openMenu = new Intent(confirm.this,ViewDiabetes.class);
			confirm.this.startActivity(openMenu);
			break;
		/*case R.id.change:
